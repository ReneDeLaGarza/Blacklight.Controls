...
namespace Blacklight.Controls
{
    ...
    public class DragDockPanelHost : ItemsControl
    {
        ...
        #region CancelPanelResizingAnimation


        public bool CancelPanelResizingAnimation
        {
            get { return (bool)GetValue(CancelPanelResizingAnimationProperty); }
            set { SetValue(CancelPanelResizingAnimationProperty, value); }
        }

        public static readonly DependencyProperty CancelPanelResizingAnimationProperty =
            DependencyProperty.Register("CancelPanelResizingAnimation", typeof(bool), typeof(DragDockPanelHost), new PropertyMetadata(null));
        ...
        protected virtual void PreparePanel(DragDockPanel panel)
        {
            ...
            if (panel.PanelState == PanelState.Maximized)
            {
                ...
                foreach (DragDockPanel dragDockPanel in this.panels)
                {
                    ...
                    {
                        dragDockPanel.MinimizeInternal();
                    }
                }
            }
        }
        ...
        public void ForceUpdatePanelLayout()
        {
            UpdatePanelLayout();
        }
        ...
        private void UpdatePanelLayout()
        {
            ...
            if (CancelPanelResizingAnimation) aw = determinedWidth; else aw = this.ActualWidth;
        ...
        public void ForceAnimatePanelSizes()
        {
            AnimatePanelSizes();
        }
        ...
        public void ForceAnimatePanelLayout()
        {
            AnimatePanelLayout();
        }
