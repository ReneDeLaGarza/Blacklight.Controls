...
namespace Blacklight.Controls
{
    ...
    public class LiveSearchListBox : ListBox
    {
        ...
        public static readonly DependencyProperty PageSizeProperty =
            DependencyProperty.Register("PageSize", typeof(int), typeof(LiveSearchListBox), new PropertyMetadata((int)10, new PropertyChangedCallback(PageProperty_Changed)));
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (this.noSearchContentPresenter != null && !DesignerProperties.GetIsInDesignMode(this))
            {
                this.noSearchContentPresenter.Visibility = Visibility.Visible;
            }
